...
b.place(x = 290, y = 300)
b = Button(window, cursor = "circle", text = "0", width = 10, font = ("Comic Sans MS", 15), bg = "lightgrey", activebackground = "black", activeforeground = "white", command = lambda : work(0))
b.place(x = 150, y = 300)
